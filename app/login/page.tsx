      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">
            {isLogin ? "Sign in to access your highlights and team" : "Join the basketball community"}
          </p>
        </div>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <Button className="w-full bg-orange-500 hover:bg-orange-600" asChild>
              <Link href="/feed">{isLogin ? "Sign In" : "Create Account"}</Link>
            </Button>
            ...
            <p className="text-center text-sm text-gray-600">
              ...
              <button onClick={() => setIsLogin(!isLogin)} className="text-orange-500 hover:underline font-medium">
